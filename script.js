...
function z(){
    ...
    if(genre=="balbharti")genre="Balbharti English";
    else if(genre=="kumarbharti")genre="Kumarbharti English";
    else if(genre=="yuvakbharti")genre="Yuvakbharti English";
    let m="";
